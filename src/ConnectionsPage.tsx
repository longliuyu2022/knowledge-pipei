...
function ConnectionsContent({ actions, version, requestedConversationId, onConversationOpened }: ConnectionsProps) {
  const [tab, setTab] = useState<ConnectionTab>(requestedConversationId ? 'conversations' : 'saved');
